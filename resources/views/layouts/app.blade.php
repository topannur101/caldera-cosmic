...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}" class="{{ session("bg") }}">
    ...
    <body class="font-sans {{ session("accent") }} {{ session("pattern") }} antialiased">
        <div class="min-h-screen bg-neutral-100 dark:bg-neutral-900">
            ...
            >
                <template x-for="(toast, index) in toasts" :key="toast.id">
                    ...
                    >
                        <span
                            class="relative flex flex-col items-start shadow-[0_5px_15px_-3px_rgb(0_0_0_/_0.08)] w-full transition-all duration-300 ease-out bg-white border border-neutral-100 sm:rounded-md sm:max-w-xs group dark:bg-neutral-800 dark:border-neutral-700"
                        ...
                        >
                                ...
                                <div class="relative">
                                    <div
                                        ...
                                        :class="{
                                            ...
                                            'text-neutral-800 dark:text-neutral-200' : toast.type=='default'
                                        }"
                                    >
                                        <svg
                                        ...
                                        <p class="text-[13px] font-medium leading-none text-neutral-800 dark:text-neutral-200" x-text="toast.message"></p>
                                    </div>
                                    <p
                                        x-show="toast.description"
                                        :class="{ 'pl-5' : toast.type!='default' }"
                                        class="mt-1.5 text-xs leading-none opacity-70 text-neutral-600 dark:text-neutral-400"
                            ...
                            <span
                                ...
                                class="absolute right-0 p-1.5 mr-2.5 text-neutral-400 duration-100 ease-in-out rounded-full opacity-0 cursor-pointer hover:bg-neutral-50 hover:text-neutral-500 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
                                :class="{
                                    'top-1/2 -translate-y-1/2' : !toast.description && !toast.html,
                                    'top-0 mt-2.5' : (toast.description || toast.html),
                                    'opacity-100' : toastHovered, 'opacity-0' : !toastHovered
                                }"
                            >
        ...
        <!-- Chart.js and Required Plugins - TAMBAHAN INI -->
