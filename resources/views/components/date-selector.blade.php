    ...
    <x-modal name="date-selector" maxWidth="sm">
        <div class="grid grid-cols-1 gap-y-6 p-6">
            ...
            <div class="flex justify-end">
                <x-text-button class="text-xs uppercase font-semibold" type="button" wire:click="resetDates" x-on:click="$dispatch('close');" x-show="date_fr || date_to">
                    <span class="text-red-500"><div class="px-1">{{ __("Hapus filter tanggal") }}</div></span>
                </x-text-button>
            </div>
        </div>
    </x-modal>
