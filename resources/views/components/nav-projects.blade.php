<header class="bg-white dark:bg-neutral-800 shadow">
   <div class="flex justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       <div class="space-x-6 -my-px ml-10 flex">
            ...
            <x-nav-link class="text-sm px-6 uppercase" href="{{ route('inventory.reqs.index') }}" :active="request()->is('inventory/manage*')" wire:navigate>
       ...
       {{-- <div class="space-x-8 -my-px ml-10 flex">
           ...
           <x-nav-link href="{{ route('inventory.reqs.index') }}" :active="request()->is('inventory/admin*')" wire:navigate>
