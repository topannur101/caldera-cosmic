<header class="bg-white dark:bg-neutral-800 shadow">
   <div class="flex justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       <div class="space-x-8 -my-px ml-10 flex">
            <x-nav-link class="text-sm px-1 uppercase" href="{{ route('projects.schedule.index') }}" :active="request()->is('projects/schedule*')" wire:navigate>
            ...
            <x-nav-link class="text-sm px-1 uppercase" href="{{ route('projects.summary.index') }}" :active="request()->is('projects/summary*')" wire:navigate>
