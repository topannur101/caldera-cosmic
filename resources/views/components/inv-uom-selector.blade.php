...
<div x-data="{
    ...
    <x-text-button
        ...
        type="button"
        x-on:click.prevent="$dispatch('open-modal', 'uom-selector')"
        ::class="
            uom
        ...
        "
    >
        <i class="icon-ruler-dimension-line me-3"></i>
        <span x-text="uom ? uom : '{{ __("UOM") }}'"></span>
    </x-text-button>
    <x-modal name="uom-selector" maxWidth="sm" focusable>
        <div class="p-6 flex flex-col gap-y-6">
            ...
            <div class="flex justify-end">
                <x-text-button class="text-xs uppercase font-semibold" type="button" x-on:click="uom = ''; $dispatch('close');" x-show="uom">
