...
>
    <x-text-button
        ...
        type="button"
        x-on:click.prevent="$dispatch('open-modal', 'loc-selector')"
        ::class="
            loc_name
        ...
        "
    >
        <i class="icon-map-pin me-3"></i>
        <span x-text="loc_name ? loc_name : '{{ __("Lokasi") }}'"></span>
    </x-text-button>
    <x-modal name="loc-selector" maxWidth="sm" focusable>
        <div class="p-6 flex flex-col gap-y-6">
            ...
            <div class="flex justify-end">
                <x-text-button class="text-xs uppercase font-semibold" type="button" x-on:click="loc_parent = ''; loc_bin = ''; $dispatch('close');" x-show="loc_parent || loc_bin">
