...
<div
    ...
    x-show="show"
    class="fixed inset-0 overflow-y-auto px-4 py-8 sm:px-0 z-50 flex"
...
>
    ...
    <div
        x-show="show"
        class="my-auto bg-white dark:bg-neutral-800 rounded-lg overflow-hidden shadow-xl transform transition-all w-full {{ $maxWidth }} sm:mx-auto"
        x-transition:enter="ease-out duration-300"
