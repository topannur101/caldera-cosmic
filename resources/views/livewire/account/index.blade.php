...
<div class="py-12">
    <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-1 my-8">
            ...
            <x-card-button type="button" x-data="" x-on:click.prevent="$dispatch('open-modal', 'change-password')">
                <div class="flex px-8">
                    <div>
                        <div class="flex pr-5 h-full text-neutral-600 dark:text-neutral-400">
            ...
            <x-card-button type="button" x-data="" x-on:click.prevent="$dispatch('open-modal', 'change-language')">
                <div class="flex px-8">
                    <div>
                        <div class="flex pr-5 h-full text-neutral-600 dark:text-neutral-400">
            ...
            <x-card-link wire:navigate href="{{ route('account.theme') }}">
                <div class="flex px-8">
                    <div>
                        <div class="flex pr-5 h-full text-neutral-600 dark:text-neutral-400">
                            <div class="m-auto"><i class="icon-swatch-book"></i></div>
                        </div>
                    </div>
                    <div class="grow truncate py-4">
                        <div class="truncate text-lg font-medium text-neutral-900 dark:text-neutral-100">
