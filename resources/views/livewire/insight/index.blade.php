        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="flex">
                            ...
                            <div class="flex grow py-4 px-2 sm:p-6">
                                <div class="grow">
                                    ...
                                    <div class="text-sm text-neutral-600 dark:text-neutral-400">
                                        {{ __('Sistem kendali ketebalan rubber yang terletak di proses pembuatan calendar.') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="flex grow py-4 px-2 sm:p-6">
                                <div class="grow">
                                    ...
                                    <div class="text-sm text-neutral-600 dark:text-neutral-400">
                                        {{ __('Sistem informasi metrik kinerja dan konsumsi dari mesin potong CZ dan NEK.') }}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                ...
                <div class="grid gap-2">
                    ...
                    <x-card-link href="{{ route('insight.erd.index') }}" wire:navigate>
                        <div class="flex">
                            <div>
                                <div class="relative flex w-32 h-full bg-neutral-200 dark:bg-neutral-700">
                                    <div class="m-auto">
