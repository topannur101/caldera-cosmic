    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <div class="bg-white dark:bg-neutral-800 shadow overflow-hidden sm:rounded-lg divide-y divide-neutral-200 dark:text-white dark:divide-neutral-700">
                <a href="{{ route('insight.omv.index') }}" class="block hover:bg-caldy-500 hover:bg-opacity-10" wire:navigate>
                ...
                <a href="{{ route('insight.rtc.index') }}" class="block hover:bg-caldy-500 hover:bg-opacity-10" wire:navigate>
                    <div class="flex items-center">
                        <div class="px-6 py-3">
                            <img src="/ink-rtc.svg" class="w-16 h-16 dark:invert">
                        </div>
                        <div class="grow">
                            <div class=" text-lg font-medium text-neutral-900 dark:text-neutral-100">{{ __('Kendali tebal rubber') }}</div>
                            <div class="flex flex-col gap-y-2 text-neutral-600 dark:text-neutral-400">
                                <div class="flex items-center gap-x-2 text-xs uppercase text-neutral-500">
                ...
                <a href="{{ route('insight.rdc.index') }}" class="block hover:bg-caldy-500 hover:bg-opacity-10" wire:navigate>
                    <div class="flex items-center">
                        <div class="px-6 py-3">
        ...
        <div class="flex flex-col gap-6">
            <div>
                ...
                <div class="bg-white dark:bg-neutral-800 shadow overflow-hidden sm:rounded-lg divide-y divide-neutral-200 dark:text-white dark:divide-neutral-700">
                    <a href="{{ route('insight.stc.index') }}" class="block hover:bg-caldy-500 hover:bg-opacity-10" wire:navigate>
                        <div class="flex items-center">
                            <div class="px-6 py-3">
            ...
            <div>
                ...
                <div class="bg-white dark:bg-neutral-800 shadow overflow-hidden sm:rounded-lg divide-y divide-neutral-200 dark:text-white dark:divide-neutral-700">
                    <a href="{{ route('insight.ldc.create.index') }}" class="block hover:bg-caldy-500 hover:bg-opacity-10" wire:navigate>
                        <div class="flex items-center">
                            <div class="px-6 py-3">
