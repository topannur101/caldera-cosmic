   ...
   public function showDSum(int $id)
   {
      ...
      if ($dSum) {
        ...
        $this->js("
                ...
                printChartContainer.innerHTML = '<div id=\"print-chart\" style=\"width:100%; height:100%;\"></div>';
                    ...
                    <dd>
                        <table class="table table-xs table-col-heading-fit">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $dSum->ins_stc_machine->code . ' ('. $dSum->ins_stc_machine->name .')' }}
                                </td>
                            </tr>
                            <tr>
                                <td class="text-neutral-500 dark:text-neutral-400 text-sm">
