    ...
    @else
        ...
        fetchLine();">
            ...
            <div class="flex flex-col sm:flex-row gap-x-4 p-2">
                <div>
                    <livewire:insight.omv.create.batches />
                </div>
                <div class="w-full">
                    <div class="flex flex-col h-full gap-y-4">
                        ...
                        <div x-show="!recipe" class="grow">
                            <div
                                class="relative overflow-hidden bg-white dark:bg-neutral-800 bg-opacity-80 dark:bg-opacity-80 shadow rounded-lg h-full flex items-center">
