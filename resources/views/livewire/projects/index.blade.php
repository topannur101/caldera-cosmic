...
// resources/livewire/projects/index.blade.php
            ...
            <div class="flex flex-wrap sm:-mx-3">
               <div class="w-full md:w-1/2 md:px-3">
                     <div
                        ...
                        <h1
                           class="text-4xl font-bold tracking-tight text-neutral-900 dark:text-neutral-300 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                                 <span class="block xl:inline">{{ __('Kelola proyek dengan mudah') }}</span>
                        </h1>
                        <p class="mx-auto text-base text-neutral-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                           {{ __('Satu tempat untuk segala keperluan manajemen proyek, mulai dari perencanaan, penugasan, hingga pelacakan secara real-time.') }}
                        </p>
                     </div>
                     <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                           ...
                           @endguest
                           <a href="{{ route('projects.items.index') }}" wire:navigate
               ...
               <div class="w-full md:w-1/2">
                  <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                     <img src="/projects.jpg" class="dark:invert" alt="Manajemen proyek">
                  </div>
               </div>
            </div>
         </div>
