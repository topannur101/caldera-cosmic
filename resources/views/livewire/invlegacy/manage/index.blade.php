...
<div id="content" class="py-12 max-w-xl mx-auto sm:px-6 lg:px-8 text-neutral-800 dark:text-neutral-200">
  <div class="grid grid-cols-2">
      <x-tab href="{{ route('invlegacy.manage.index', [ 'nav' => 'inventory' ])}}" wire:navigate :active="!$view" class="text-center">{{__('Inventaris')}}</x-tab>
      <x-tab href="{{ route('invlegacy.manage.index', [ 'nav' => 'inventory', 'view' => 'administration' ])}}" wire:navigate :active="$view == 'administration'" class="text-center">{{__('Administrasi')}}</x-tab>
  </div>
  @if(!$view)
  ...
  @endcannot
  <div class="grid grid-cols-1 gap-1 my-8">
      <x-card-link href="{{ route('invlegacy.manage.auths') }}" wire:navigate>
          <div class="flex">
              <div>
                  <div class="flex w-16 h-full text-neutral-600 dark:text-neutral-400">
      ...
      <x-card-link href="{{ route('invlegacy.manage.areas') }}" wire:navigate>
          <div class="flex">
              <div>
                  <div class="flex w-16 h-full text-neutral-600 dark:text-neutral-400">
      ...
      <x-card-link href="{{ route('invlegacy.manage.currs') }}" wire:navigate>
          <div class="flex">
              <div>
                  <div class="flex w-16 h-full text-neutral-600 dark:text-neutral-400">
      ...
      <x-card-link href="{{ route('invlegacy.manage.uoms') }}" wire:navigate>
          <div class="flex">
              <div>
                  <div class="flex w-16 h-full text-neutral-600 dark:text-neutral-400">
