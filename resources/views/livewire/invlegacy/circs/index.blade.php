...
class extends Component {
  ...
  public function mount()
    ...
    {
        return redirect(route('invlegacy.circs.print'))->with('ids', $this->ids);
    }
    ...
    <div class="flex flex-col gap-x-2 md:gap-x-4 sm:flex-row">
        <div>
            <div class="w-full sm:w-44 md:w-64 px-3 sm:px-0">
                <x-text-input-icon wire:model.live="q" icon="icon-search" id="inv-q" type="search"
                ...
                <div class="py-4">
                    ...
                    <div class="m-3">
                        <x-text-button type="button" wire:click="download" class="text-sm">
                            <i class="mr-2 icon-download"></i>{{ __('Unduh CSV sirkulasi') }}</x-text-button>
                    </div>
                </div>
                ...
                <div class="flex gap-x-2 items-center">
                    ...
                    <div class="btn-group">
                        ...
                        <x-secondary-button type="button" x-on:click="$dispatch('open-modal', 'inv-circs-reject')"
                            class="flex items-center"><i class="icon-thumbs-down"></i></x-secondary-button>
                    </div>
            ...
            @if (!$circs->count())
                ...
                @elseif (!count($status))
                    <div wire:key="no-qdirs" class="py-20">
                        <div class="text-center text-neutral-300 dark:text-neutral-700 text-5xl mb-3">
                            <i class="icon-thumbs-up relative"><i
                                    class="icon-circle-help absolute bottom-0 -right-1 text-lg text-neutral-500 dark:text-neutral-400"></i></i>
                        </div>
                ...
                @elseif (!count($qdirs))
                    <div wire:key="no-qdirs" class="py-20">
                        <div class="text-center text-neutral-300 dark:text-neutral-700 text-5xl mb-3">
                            <i class="icon-plus-minus relative"><i
                                    class="icon-circle-help absolute bottom-0 -right-1 text-lg text-neutral-500 dark:text-neutral-400"></i></i>
                        </div>
