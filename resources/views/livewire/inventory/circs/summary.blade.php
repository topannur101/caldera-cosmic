...
new #[Layout("layouts.app")] class extends Component {
    ...
    public function update()
    {
        $this->js(
            ...
            const amountDeposit = " .
                json_encode($this->amountDepositPercentage()) .
                ";
            ...
            const amountWithdrawal = " .
                json_encode($this->amountWithdrawalPercentage()) .
                ";
    ...
    public function amountDepositPercentage()
    {
        ...
        $totalDepositAmount = InvCirc::whereHas("inv_item", function ($query) {
            ...
            ->whereBetween("updated_at", [$this->date_fr, $this->date_to])
            ->sum("amount");
...
<div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 text-neutral-700 dark:text-neutral-200">
    <div
        class="flex flex-col lg:flex-row w-full bg-white dark:bg-neutral-800 divide-x-0 divide-y lg:divide-x lg:divide-y-0 divide-neutral-200 dark:divide-neutral-700 shadow sm:rounded-lg lg:rounded-full py-0 lg:py-2 mb-6"
    >
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div class="flex gap-x-3">
                ...
                <div wire:ignore id="amount-deposit-percentage-container" class="h-32 overflow-hidden" wire:key="amount-deposit-container"></div>
            </div>
        </div>
        <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div class="flex gap-x-3">
                ...
                <div wire:ignore id="amount-withdrawal-percentage-container" class="h-32 overflow-hidden" wire:key="amount-withdrawal-container"></div>
            </div>
        </div>
    </div>
    <div class="mt-4">
        <div class="col-span-2 bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div wire:ignore id="amount-value-container" class="overflow-hidden" wire:key="amount-value-container"></div>
        </div>
    </div>
</div>
