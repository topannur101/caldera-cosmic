...
<div class="block sm:flex gap-x-6">
    <livewire:inventory.items.photo isForm="true" :url="$inv_item->photo ?? false ? $url : ''" />
    <form wire:submit="save()" class="w-full overflow-hidden">
        <div class="px-4 pb-4">
            ...
            <div class="bg-white dark:bg-neutral-800 shadow rounded-lg p-4 mb-4">
                ...
                <livewire:inventory.items.loc isForm="true" :$loc :$inv_area_id />
                ...
                <div class="mx-3 mt-3">
                    ...
                    <x-modal name="inv-item-tags">
                        <livewire:inventory.items.tags isForm="true" :$tags :$inv_area_id lazy />
                    </x-modal>
                </div>
