   ...
   <form wire:submit="save" class="p-6">
      ...
      <div class="mb-6">
         <div class="grid grid-cols1 sm:grid-cols-2 mt-6 gap-y-6 gap-x-3">
            <div>
               <label for="edit-qty_min"
                     class="block px-3 mb-2 uppercase text-xs text-neutral-500">{{ __('Qty mininum') }}</label>
               <x-text-input id="edit-qty_min" wire:model="qty_min" type="text"
                     autocomplete="off" />
            </div>
            <div>
               <label for="edit-qty_max"
                     class="block px-3 mb-2 uppercase text-xs text-neutral-500">{{ __('Qty maksimum') }}</label>
               <x-text-input id="edit-qty_max" wire:model="qty_max" type="text"
                     autocomplete="off" />
            </div>
         </div>
      </div>
