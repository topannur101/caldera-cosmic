...
<x-slot name="title">{{ __('Perbarui unit stok') . ' — ' . __('Inventaris') }}</x-slot>
   ...
   @if (count($areas))
      ...
      x-init="editorInit()">
         <div class="flex flex-col sm:flex-row gap-y-6 justify-between px-6 mb-8">
            <h1 class="text-2xl text-neutral-900 dark:text-neutral-100"><i class="fa-money-check-dollar mr-3"></i>{{ __('Perbarui unit stok') }}</h1>
