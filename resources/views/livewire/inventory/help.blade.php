    ...
    <div class="p-4 bg-white dark:bg-neutral-800 shadow sm:rounded-lg overflow-hidden">
        ...
        <div class="relative w-full">
            <div
                ...
                :class="{ 'border-caldy-500' : activeAccordion==id, 'border-transparent' : activeAccordion!=id }"
                class="duration-200 ease-out border rounded-md cursor-pointer group overflow-hidden"
                x-cloak
            >
                <button @click="setActiveAccordion(id)" class="flex items-center justify-between w-full px-5 py-4 text-left select-none">
                    ...
                    <div :class="{ 'rotate-90': activeAccordion==id }" class="relative flex items-center justify-center w-2.5 h-2.5 duration-300 ease-out">
                        ...
                        <div
                            ...
                            class="absolute w-full h-0.5 ease duration-500 bg-neutral-500 group-hover:bg-neutral-800 dark:group-hover:bg-neutral-300 rounded-full"
                        ></div>
                    </div>
                </button>
