                    ...
                    <div class="grid grid-cols-3 gap-x-6">
                        <div>
                            ...
                            <ol class="relative border-s border-neutral-200 dark:border-neutral-700">
                                <li
                                    @if( $batch['omv_eval'] ) wire:click="showBatch({{ $batch_id }}, 'omv')" @endif
                                    tabindex="0"
                                    class="ms-3 px-3 py-4 cursor-pointer rounded hover:bg-caldy-500 hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-caldy-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 transition ease-in-out duration-150"
                                >
                                    <div
                                    ...
                                    <x-pill
                                        class="uppercase"
                                        color="{{ $batch['omv_eval'] === 'on_time' ? 'green' : ($batch['omv_eval'] === 'on_time_manual' ? 'yellow' : ($batch['omv_eval'] === 'too_late' || $batch['omv_eval'] === 'too_soon' ? 'red' : 'neutral')) }}"
                                    >
                                        {{ $batch["omv_eval_human"] ?: "N/A" }}
                                    </x-pill>
                                </li>
                                <li class="ms-3 px-3 py-4">
                                    ...
                                    <x-pill class="uppercase" color="neutral">N/A</x-pill>
                                </li>
                                <li
                                    @if( $batch['rdc_eval'] ) wire:click="showBatch({{ $batch_id }}, 'rdc')" @endif
                                    tabindex="0"
                                    class="ms-3 px-3 py-4 cursor-pointer rounded hover:bg-caldy-500 hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-caldy-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 transition ease-in-out duration-150"
                                >
                                    <div
                                    ...
                                    <x-pill
                                        class="uppercase"
                                        color="{{ $batch['rdc_eval'] === 'queue' ? 'yellow' : ($batch['rdc_eval'] === 'pass' ? 'green' : ($batch['rdc_eval'] === 'fail' ? 'red' : 'neutral')) }}"
                                    >
                                        {{ $batch["rdc_eval_human"] ?: "N/A" }}
                                    </x-pill>
                                </li>
                                <li class="ms-3 px-3 py-4">
                                    <div
