...
<x-slot name="title">{{ __("Kelola") . " — " . __("Pemantauan IP Blending") }}</x-slot>
...
<div class="py-12">
    <div class="max-w-xl mx-auto sm:px-6 lg:px-8 text-neutral-600 dark:text-neutral-400">
        ...
        <div class="grid grid-cols-1 gap-1 my-8">
            <x-card-link href="{{ route('insights.ibms.manage.auths') }}" wire:navigate>
                <div class="flex px-8">
                    <div>
                    ...
                    <div class="grow truncate py-4">
                        ...
                        <div class="truncate text-sm text-neutral-600 dark:text-neutral-400">
                            {{ __("Kelola wewenang pengguna IP Blending Monitoring System") }}
                        </div>
                    </div>
                </div>
            </x-card-link>
            <x-card-link href="{{ route('insights.ibms.manage.devices') }}" wire:navigate>
                <div class="flex px-8">
                    <div>
                        <div class="flex pr-5 h-full text-neutral-600 dark:text-neutral-400">
                    ...
                    <div class="grow truncate py-4">
                        ...
                        <div class="truncate text-sm text-neutral-600 dark:text-neutral-400">
                            {{ __("Kelola perangkat IBMS dan konfigurasi line") }}
                        </div>
                    </div>
                </div>
            </x-card-link>
