...
new #[Layout("layouts.app")] class extends Component {
    ...
    {
        $this->devices = InsIbmsDevice::orderBy('name')->get();
    }
...
<x-slot name="title">{{ __("Perangkat") . " — " . __("Pemantauan IP Blending Monitoring System") }}</x-slot>
<x-slot name="header">
    ...
    <div>
        ...
        <div class="flex flex-col sm:flex-row gap-y-6 justify-between px-6">
            ...
            <div class="flex justify-end gap-x-2">
                @can("manage", InsIbmsDevice::class)
        ...
        <div wire:key="device-create-modal-wrapper">
            <x-modal name="device-create" maxWidth="xl">
                <livewire:insights.ibms.manage.device-create wire:key="ibms-device-create-modal" lazy />
            </x-modal>
        </div>
        <div wire:key="device-edit-modal-wrapper">
            <x-modal name="device-edit" maxWidth="xl">
                <livewire:insights.ibms.manage.device-edit wire:key="ibms-device-edit-modal" lazy />
            </x-modal>
        </div>
    </div>
</div>
