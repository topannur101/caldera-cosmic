...
new #[Layout("layouts.app")] class extends Component {
    ...
    {
        $q = trim($this->q);
        $auths = InsIbmsAuth::join("users", "ins_ip_blend_auths.user_id", "=", "users.id")
            ->select("ins_ip_blend_auths.*", "users.name as user_name", "users.emp_id as user_emp_id", "users.photo as user_photo")

            ->orderBy("ins_ip_blend_auths.user_id", "desc")
            ->orderBy("ins_ip_blend_auths.actions", "desc");
...
<x-slot name="title">{{ __("Wewenang") . " — " . __("Pemantauan IP Blending Monitoring System") }}</x-slot>
<x-slot name="header">
    <x-nav-insights-ibms-sub />
</x-slot>
    ...
    <div>
        ...
        <div wire:key="auth-create">
            <x-modal name="auth-create">
                <livewire:insights.ibms.manage.auth-create />
            </x-modal>
        </div>
        <div wire:key="auth-edit">
            <x-modal name="auth-edit">
                <livewire:insights.ibms.manage.auth-edit />
            </x-modal>
        </div>
