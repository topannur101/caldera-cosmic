...
new class extends Component {
    ...
    public function rules()
    {
        return [
            ...
            // DWP Alarm validations (optional fields for create should still be integers)
    ...
    public function save()
    {
        ...
        // Process lines to ensure proper format (same structure as edit)
                ...
                <div class="border border-neutral-300 dark:border-neutral-700 rounded-lg p-4 mb-4"
                    ...
                    <div class="flex gap-x-3 items-center mb-4">
                        ...
                        <div class="grow">
                            ...
                            <x-text-input type="text" wire:model="lines.{{ $lineIndex }}.line" />
                    ...
                    <div class="bg-neutral-50 dark:bg-neutral-800 rounded p-3 mb-4">
                        ...
                        <div class="grid grid-cols-5 gap-3">
                            <div>
                                ...
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_dd_1" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">DD2</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_dd_2" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">DD3</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_dd_3" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">DD4</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_dd_4" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">DD5</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_dd_5" placeholder="0" />
                            </div>
                        </div>
                        <div class="grid grid-cols-5 gap-3 mt-3">
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">Reset</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_reset" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">Control</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_control" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">Counter</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_counter" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">Data Storage</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_data_storage" placeholder="0" />
                            </div>
                            <div>
                                <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">Long Duration</label>
                                <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.dwp_alarm.addr_long_duration" placeholder="0" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="bg-neutral-100 dark:bg-neutral-700 rounded p-3">
                                <div class="flex justify-between items-start mb-3">
                                    <div class="grow">
                                        ...
                                        <x-text-input type="text" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.name" />
                                    </div>
                                ...
                                <div class="grid grid-cols-4 gap-3">
                                    <div>
                                        ...
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_th_l" placeholder="0" />
                                    </div>
                                    <div>
                                        <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">T/H Right</label>
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_th_r" placeholder="0" />
                                    </div>
                                    <div>
                                        <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">Side Left</label>
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_side_l" placeholder="0" />
                                    </div>
                                    <div>
                                        <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">Side Right</label>
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_side_r" placeholder="0" />
                                    </div>
                                </div>
                                <div class="grid grid-cols-4 gap-3 mt-3">
                                    <div>
                                        <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">STD T/H Max</label>
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_std_th_max" placeholder="0" />
                                    </div>
                                    <div>
                                        <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">STD T/H Min</label>
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_std_th_min" placeholder="0" />
                                    </div>
                                    <div>
                                        <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">STD Side Max</label>
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_std_side_max" placeholder="0" />
                                    </div>
                                    <div>
                                        <label class="block px-3 mb-2 uppercase text-xs text-neutral-500">STD Side Min</label>
                                        <x-text-input type="number" wire:model="lines.{{ $lineIndex }}.list_mechine.{{ $machineIndex }}.addr_std_side_min" placeholder="0" />
                                    </div>
                                </div>
                            </div>
                        @endforeach
