...
new class extends Component {
    ...
    public function with(): array
    {
        ...
        $clumps = DB::table("ins_rtc_metrics")
            ...
            ->selectRaw(
                "ROUND((AVG(CASE WHEN ins_rtc_metrics.sensor_left <> 0 THEN ins_rtc_metrics.sensor_left END) - ins_rtc_recipes.std_mid) / ins_rtc_recipes.std_mid * 100, 0) as dp_left",
            )
            ->selectRaw(
                "ROUND((AVG(CASE WHEN ins_rtc_metrics.sensor_right <> 0 THEN ins_rtc_metrics.sensor_right END) - ins_rtc_recipes.std_mid) / ins_rtc_recipes.std_mid * 100, 0) as dp_right",
            )
        ...
        $clumps->groupBy("ins_rtc_devices.line", "ins_rtc_clumps.id", "ins_rtc_recipes.id")->orderBy("end_time", "desc");
