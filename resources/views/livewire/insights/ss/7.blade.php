...
<div class="w-full h-screen p-4">
    <div class="h-2/6 p-4">
        <div class="flex w-full justify-between">
            <div class="truncate">
                <div>
                    <div class="text-4xl text-neutral-400 uppercase m-1"><x-link class="inline-block" href="{{ route('insights.ctc.slideshows')}}"><i class="icon-chevron-left"></i></x-link>
                        {{ __('Model') }}</div>
