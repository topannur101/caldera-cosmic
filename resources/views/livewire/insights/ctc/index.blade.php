...
<div id="content" class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 text-neutral-800 dark:text-neutral-200">
    <div wire:key="ctc-index-nav" class="flex px-8 mb-6">
    ...
    <div wire:key="ctc-index-container" wire:loading.class="hidden">
        @switch($view)
            @case('realtime')
            ...
            @case('quality')
                <livewire:insights.ctc.quality.analysis />
            @break

            @case('recipes')
                <livewire:insights.ctc.manage.recipes />
            @break
