...
new class extends Component {
    ...
    public function save()
    {
        ...
        if ($device) {
            ...
            $this->js('toast("' . __("Alat diperbarui") . '", { type: "success" })');
    ...
    public function delete()
    {
        ...
        if ($device) {
            ...
            $this->js('$dispatch("close")');
            $this->js('toast("' . __("Alat dihapus") . '", { type: "success" })');
            $this->dispatch("updated");
        } else {
            $this->handleNotFound();
        }
    ...
    <form wire:submit="save" class="p-6">
        ...
        <div class="mb-6">
            ...
            <div class="mt-6">
                ...
                <x-text-input id="device-line" wire:model="line" :disabled="Gate::denies('manage', InsRtcDevice::class)" type="number" min="1" max="99" />
                @error("line")
            ...
            <div class="mt-6">
                ...
                <x-text-input id="device-ip-address" wire:model="ip_address" :disabled="Gate::denies('manage', InsRtcDevice::class)" type="text" />
                @error("ip_address")
                    <x-input-error messages="{{ $message }}" class="px-3 mt-2" />
                @enderror
            </div>
