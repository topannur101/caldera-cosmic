...
new #[Layout("layouts.app")] class extends Component {
    ...
    public function with(): array
    {
        ...
        $numeratorIntegrity = $u
            ->groupBy("date_hour_device_id")
            ->get()
            ->count();
    ...
    <div>
        <div class="flex justify-between items-center mb-6 px-5 py-1">
            ...
            <div class="flex gap-x-2 items-center">
                <div class="text-sm">
                    <span class="text-neutral-500">{{ __("Hari:") . " " }}</span>
                    <span>{{ $days }}</span>
                </div>
                <div class="text-sm">
                    <span class="text-neutral-500">{{ __("Integritas:") . " " }}</span>
                    <span>{{ $integrity . "% " }}</span>
                </div>
