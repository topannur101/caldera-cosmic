...
<div>
    ...
    <div wire:key="stc-data-batch-count" class="grid grid-cols-1 sm:grid-cols-2 gap-3 h-[32rem]">
        <div wire:key="stc-data-adjustment-chart" class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4 sm:p-6 overflow-hidden"
            id="stc-data-adjustment-chart-container" wire:key="stc-data-adjustment-chart-container" wire:ignore> 
        </div>
        <div wire:key="stc-data-integrity-chart" class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4 sm:p-6 overflow-hidden"
            id="stc-data-integrity-chart-container" wire:key="stc-data-integrity-chart-container" wire:ignore>
        </div>
    </div>
</div>
