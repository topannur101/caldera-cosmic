        ...
        <div class="mt-6">
            ...
            <div class="mb-3">
                ...
                <div class="grid grid-cols-8 gap-1">
                    <x-text-input-t class="text-center" placeholder="83" wire:model="section_limits_high.0" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="78" wire:model="section_limits_high.1" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="73" wire:model="section_limits_high.2" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="68" wire:model="section_limits_high.3" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="63" wire:model="section_limits_high.4" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="58" wire:model="section_limits_high.5" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="53" wire:model="section_limits_high.6" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="48" wire:model="section_limits_high.7" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                </div>
            </div>
            <div>
                <label class="block text-xs uppercase text-neutral-500">{{ __('Minimum') }}</label>
                <div class="grid grid-cols-8 gap-1">
                    <x-text-input-t class="text-center" placeholder="73" wire:model="section_limits_low.0" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="68" wire:model="section_limits_low.1" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="63" wire:model="section_limits_low.2" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="58" wire:model="section_limits_low.3" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="53" wire:model="section_limits_low.4" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="48" wire:model="section_limits_low.5" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="43" wire:model="section_limits_low.6" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                    <x-text-input-t class="text-center" placeholder="38" wire:model="section_limits_low.7" :disabled="Gate::denies('manage', InsStcMachine::class)" type="number" min="30" max="99" />
                </div>
            </div>
