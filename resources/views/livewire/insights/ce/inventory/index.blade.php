               ...
               <div class="w-full md:w-1/2 md:px-3">
                     <div
                        ...
                        <h1
                           class="text-4xl font-bold tracking-tight text-neutral-900 dark:text-neutral-300 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                                 <span class="block xl:inline">{{ __('Kelola barang kimia dengan mudah') }}</span>
                        </h1>
                        <p class="mx-auto text-base text-neutral-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                           {{ __('Satu tempat untuk segala keperluan inventaris kimia, mulai dari manajemen barang, pencatatan keluar masuk, hingga kebutuhan analisis.') }}
                        </p>
                     </div>
                     <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                           ...
                           <a href="{{ route('inventory.help') }}" wire:navigate
                                 ...
                                 {{ __('Tonton panduan inventaris kimia') }}
                                 <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-1" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <line x1="5" y1="12" x2="19" y2="12">
                        ...
                        <div class="text-neutral-500 text-sm mb-10">
                           <div class="flex flex-wrap gap-2 items-center">
                              <div class="mb-1">{{ __('Digunakan Oleh departemen:') }}</div>
