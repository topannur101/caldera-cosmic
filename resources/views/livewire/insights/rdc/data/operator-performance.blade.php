...
new class extends Component {
    ...
    {
        if (count($this->operator_stats) === 0) {
            return;
        }
...
<div>
    <div class="p-0 sm:p-1 mb-6">
        <div class="flex flex-col lg:flex-row gap-3 w-full bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 gap-3">
                <div class="w-full">
                    <label for="operator-machine" class="block px-3 mb-2 uppercase text-xs text-neutral-500">{{ __("MC") }}</label>
                ...
                <div class="space-y-6 text-sm text-neutral-600 dark:text-neutral-400">
                    <div>
                        ...
                        <div class="bg-neutral-50 dark:bg-neutral-800 p-3 rounded text-xs font-mono">
                            ...
                            <br />
                            {{ __("Pass rate tinggi = keterampilan operator baik") }}
                            <br />
                    ...
                    <div>
                        ...
                        <div class="bg-neutral-50 dark:bg-neutral-800 p-3 rounded text-xs font-mono">
                            {{ __("Rumus: Total Uji / Jumlah Hari Aktif") }}
                            <br />
                            {{ __("Tinggi = produktivitas operator tinggi") }}
                            <br />
                    ...
                    <div>
                        ...
                        <div class="bg-neutral-50 dark:bg-neutral-800 p-3 rounded text-xs font-mono">
                            {{ __("Menunjukkan variasi material yang ditangani operator") }}
                            <br />
                            {{ __("Tinggi = operator versatile, menangani banyak jenis compound") }}
                            <br />
                    ...
                    <div>
                        ...
                        <div class="bg-neutral-50 dark:bg-neutral-800 p-3 rounded text-xs font-mono">
                            {{ __("Menunjukkan fleksibilitas dan kemampuan adaptasi operator") }}
                            <br />
                            {{ __("Banyak mesin = operator multiskill, dapat mengoperasikan berbagai mesin") }}
                            <br />
                    ...
                    <div class="border-t border-neutral-200 dark:border-neutral-700 pt-4">
                        ...
                        <div class="bg-neutral-50 dark:bg-neutral-800 p-3 rounded text-xs font-mono">
                            {{ __("🥇🥈🥉 = 3 operator teratas berdasarkan volume pengujian") }}
                            <br />
                            {{ __("Volume tinggi menunjukkan operator yang produktif dan aktif") }}
                            <br />
                    ...
                    <div class="border-t border-neutral-200 dark:border-neutral-700 pt-4">
                        ...
                        <div class="space-y-2 text-xs">
                            <p>
                                •
                                <strong>Operator Ideal:</strong>
                                Volume tinggi + Pass rate tinggi + Banyak MCS/Mesin
                            </p>
                            <p>
                                •
                                <strong>Perlu Pelatihan:</strong>
                                Volume tinggi tetapi Pass rate rendah
                            </p>
                            <p>
                                •
                                <strong>Kurang Aktif:</strong>
                                Volume rendah meski Pass rate tinggi
                            </p>
                            <p>
                                •
                                <strong>Spesialis:</strong>
                                Sedikit MCS/Mesin tetapi konsisten
                            </p>
                        </div>
                    </div>
                </div>
    ...
    @if (! count($operator_stats))
        <div class="py-20">
            ...
            <div class="text-center text-neutral-500 dark:text-neutral-600">{{ __("Tidak ada data operator untuk periode ini") }}</div>
        </div>
    @else
                                    ...
                                    <td class="text-left px-4 py-3 font-medium">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <div class="w-8 h-8 inline-block bg-neutral-200 dark:bg-neutral-700 dark:bg-opacity-50 rounded-full overflow-hidden">
                                    ...
                                    <td class="text-center px-2 py-3">
                                        <span
                                            class="px-2 py-1 rounded text-xs font-medium {{
                                                $operator["pass_rate"] >= 95
                                                    ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200"
                                                    : ($operator["pass_rate"] >= 90
