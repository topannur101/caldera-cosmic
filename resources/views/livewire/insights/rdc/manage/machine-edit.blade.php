                ...
                @foreach ($available_fields as $field => $config)
                    <div class="p-6 hover:bg-caldy-500 hover:bg-opacity-10">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <x-toggle wire:model.live="field_configs.{{ $field }}.enabled" name="field_{{ $field }}_enabled"></x-toggle>
                        </div>
                                ...
                                @if ($type === "excel")
                                    ...
                                    @if (isset($field_configs[$field]) && $field_configs[$field]["config_type"] === "static")
                                        <div>
                                            ...
                                            <x-text-input type="text" wire:model="field_configs.{{ $field }}.address" class="uppercase w-full" />
                                        </div>
                                    @endif
                                    ...
                                    @if (isset($field_configs[$field]) && $field_configs[$field]["config_type"] === "dynamic")
                                        <div class="grid grid-cols-2 gap-3">
                                            <div>
                                                ...
                                                <x-text-input type="text" wire:model="field_configs.{{ $field }}.row_search" class="w-full" />
                                            </div>
                                            <div>
                                                <label class="block text-sm text-neutral-600 dark:text-neutral-400 mb-2">{{ __("Column Search") }}</label>
                                                <x-text-input type="text" wire:model="field_configs.{{ $field }}.column_search" class="w-full" />
                                            </div>
                                            <div>
                                                <label class="block text-sm text-neutral-600 dark:text-neutral-400 mb-2">{{ __("Row Offset") }}</label>
                                                <x-text-input type="number" wire:model="field_configs.{{ $field }}.row_offset" class="w-full" />
                                            </div>
                                            <div>
                                                <label class="block text-sm text-neutral-600 dark:text-neutral-400 mb-2">{{ __("Column Offset") }}</label>
                                                <x-text-input type="number" wire:model="field_configs.{{ $field }}.column_offset" class="w-full" />
                                            </div>
                                        </div>
                                    @endif
                                @else
                                    ...
                                    <div class="grid gap-y-3 mt-3">
                                        ...
                                        <div>
                                            ...
                                            <x-text-input type="text" wire:model="field_configs.{{ $field }}.pattern" class="w-full font-mono text-sm" />
                                        </div>
                                    </div>
                                @endif
                            </div>
