...
<div>
    <form wire:submit="save" class="p-6">
        ...
        <div class="grid grid-cols-1 gap-y-3 mt-6">
            ...
            --}}
            <x-checkbox id="test-manage" :disabled="!$is_superuser" wire:model="actions" value="test-manage">{{ __("Mengelola hasil uji") }}</x-checkbox>
            <x-checkbox id="machine-manage" :disabled="!$is_superuser" wire:model="actions" value="machine-manage">{{ __("Mengelola mesin rheometer") }}</x-checkbox>
            <x-checkbox id="tag-manage" :disabled="!$is_superuser" wire:model="actions" value="tag-manage">{{ __("Mengelola tag") }}</x-checkbox>
        </div>
        @can("superuser")
