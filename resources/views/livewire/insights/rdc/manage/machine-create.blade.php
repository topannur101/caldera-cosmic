...
new class extends Component {
    ...
    public int $number;
    public string $name = '';
    public string $type = 'excel'; // Default to excel
    public bool $is_active = true; // Default to active
    ...
    public function rules()
    {
        ...
        if ($this->type === 'excel') {
            ...
            foreach ($this->available_fields as $field => $config) {
                if ($this->txt_patterns[$field]['enabled']) {
    ...
    public function updatedTxtPatterns($value, $key)
    {
        ...
        if (str_ends_with($key, '.preset')) {
            ...
            if ($preset && isset($this->txt_presets[$preset])) {
                ...
                $this->txt_patterns[$field]['enabled'] = true;
            }
        }
    }
    ...
    public function customReset()
    {
        ...
        $this->mount(); // Reinitialize arrays
    }
};
?>
                                    ...
                                    @if($txt_patterns[$field]['enabled'])
                                        <div class="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                />
                                                @if($txt_patterns[$field]['preset'] && isset($txt_presets[$txt_patterns[$field]['preset']]))
