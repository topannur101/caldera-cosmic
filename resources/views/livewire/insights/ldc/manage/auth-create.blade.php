...
new class extends Component {
    ...
    {
        return [
            "user_id" => ["required", "gt:0", "integer", "unique:ins_ldc_auths"],
            "actions" => ["array"],
            "actions.*" => ["string"],
        ];
    }
...
<div>
    <form wire:submit="save" class="p-6">
        ...
        <div class="grid grid-cols-1 gap-y-3 mt-6">
            <x-checkbox id="new-hide-edit" wire:model="actions" value="hide-edit">{{ __("Menyunting data kulit") }}</x-checkbox>
            <x-checkbox id="new-machine-manage" wire:model="actions" value="machine-manage">{{ __("Mengelola mesin") }}</x-checkbox>
        </div>
