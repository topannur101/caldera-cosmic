...
<div>
    <form wire:submit="save" class="p-6">
        ...
        <div class="grid grid-cols-1 gap-y-3 mt-6">
            <x-checkbox id="hide-edit" :disabled="!$is_superuser" wire:model="actions" value="hide-edit">{{ __("Menyunting data kulit") }}</x-checkbox>
            <x-checkbox id="machine-manage" :disabled="!$is_superuser" wire:model="actions" value="machine-manage">{{ __("Kelola mesin ") }}</x-checkbox>
        </div>
        @can("superuser")
