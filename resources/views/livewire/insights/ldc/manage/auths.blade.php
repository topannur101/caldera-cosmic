...
new #[Layout('layouts.app')] class extends Component {
   use WithPagination;
    ...
    {
        $q = trim($this->q);
        $auths = InsLdcAuth::join('users', 'ins_ldc_auths.user_id', '=', 'users.id')
            ->select('ins_ldc_auths.*', 'users.name as user_name', 'users.emp_id as user_emp_id', 'users.photo as user_photo')

            ->orderBy('ins_ldc_auths.user_id', 'desc');
    ...
    <div>
        ...
        <div wire:key="auth-create">
            <x-modal name="auth-create">
                <livewire:insights.ldc.manage.auth-create  />
            </x-modal>
        </div>
        <div wire:key="auth-edit">
            <x-modal name="auth-edit">
                <livewire:insights.ldc.manage.auth-edit  />
            </x-modal>
        </div>
