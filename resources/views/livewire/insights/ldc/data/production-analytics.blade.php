...
new class extends Component {
    ...
    private function calculateMaterialStats($baseQuery)
    {
        ...
        $this->materialStats = $materialData
            ->keyBy("material")
            ->map(function ($item) {
                return [
                    "total_hides" => (int) $item->total_hides,
    ...
    private function renderCharts()
    {
        ...
        $this->js(
            ...
            (function() {
                ...
                window.linePerformanceChart = new Chart(lineCtx, " .
                json_encode($lineChartOptions) .
                ");
                ...
                window.shiftPerformanceChart = new Chart(shiftCtx, " .
                json_encode($shiftChartOptions) .
                ");
                ...
                window.throughputTrendChart = new Chart(trendCtx, " .
                json_encode($trendChartOptions) .
                ");
                ...
                window.styleAnalysisChart = new Chart(styleCtx, " .
                json_encode($styleChartOptions) .
                ");
                ...
                window.materialAnalysisChart = new Chart(materialCtx, " .
                json_encode($materialChartOptions) .
                ");
            })();
        ",
        );
...
<div>
        ...
        <div class="flex flex-col lg:flex-row gap-3 w-full bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            <div>
                ...
                <div class="grid gap-3">
                    ...
                    <div class="px-3">
                        <x-checkbox id="analytics_is_workdate" wire:model.live="is_workdate" value="is_workdate">
                        ...
                        <span
                            x-text="
                                progress < 15
                                    ? '{{ __("Mengambil data...") }}'
                                    : progress < 30
                                      ? '{{ __("Menghitung statistik line...") }}'
                                      : progress < 45
                                        ? '{{ __("Menghitung statistik shift...") }}'
                                        : progress < 60
                                          ? '{{ __("Menghitung tren harian...") }}'
                                          : progress < 75
                                            ? '{{ __("Menganalisis performa style...") }}'
                                            : progress < 90
                                              ? '{{ __("Menganalisis material...") }}'
                                              : progress < 98
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div
                class="text-xl font-bold {{ ($summaryKpis["overall_utilization"] ?? 0) >= 85 ? "text-green-500" : (($summaryKpis["overall_utilization"] ?? 0) >= 75 ? "text-yellow-500" : "text-red-500") }}"
            >
        ...
        <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div
                class="text-xl font-bold {{ ($summaryKpis["avg_defect_rate"] ?? 0) <= 10 ? "text-green-500" : (($summaryKpis["avg_defect_rate"] ?? 0) <= 20 ? "text-yellow-500" : "text-red-500") }}"
            >
        ...
        <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div
                class="text-xl font-bold {{ ($summaryKpis["avg_difference_rate"] ?? 0) <= 5 ? "text-green-500" : (($summaryKpis["avg_difference_rate"] ?? 0) <= 10 ? "text-yellow-500" : "text-red-500") }}"
            >
                    ...
                    <table class="table table-sm text-sm w-full">
                        ...
                        <tbody>
                            @foreach ($lineStats as $line => $stats)
                                <tr
                                    class="border-b border-neutral-100 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-700 cursor-pointer"
                                ...
                                >
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="{{ $stats["avg_utilization"] >= 85 ? "text-green-500" : ($stats["avg_utilization"] >= 75 ? "text-yellow-500" : "text-red-500") }}"
                                        >
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="{{ $stats["avg_defect_rate"] <= 10 ? "text-green-500" : ($stats["avg_defect_rate"] <= 20 ? "text-yellow-500" : "text-red-500") }}"
                                        >
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="{{ $stats["avg_difference_rate"] <= 5 ? "text-green-500" : ($stats["avg_difference_rate"] <= 10 ? "text-yellow-500" : "text-red-500") }}"
                                        >
