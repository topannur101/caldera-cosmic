        ...
        <div class="flex flex-col lg:flex-row gap-3 w-full bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="w-full lg:w-32">
                    <label for="hides-code" class="block px-3 mb-2 uppercase text-xs text-neutral-500">{{ __("Kode") }}</label>
                ...
                <div class="w-full lg:w-32">
                    <label for="hides-material" class="block px-3 mb-2 uppercase text-xs text-neutral-500">{{ __("Material") }}</label>
