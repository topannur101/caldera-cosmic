...
<div class="overflow-auto w-full">
    <div>
        <div class="flex justify-between items-center mb-6 px-5 py-1">
            <h1 class="text-2xl text-neutral-900 dark:text-neutral-100">{{ __("Data Mentah") }}</h1>
            <div class="flex gap-x-5 items-center">
                <div class="grow text-sm">
                    <span class="text-neutral-500">{{ __("Total") . " VN | AB : " }}</span>
                    <span>{{ $sum_area_vn . " | " . $sum_area_ab }}</span>
                    <span class="text-neutral-500 ms-4">{{ __("Total lembar") . " : " }}</span>
                    <span>{{ $hides->total() }}</span>
                </div>
