    ...
    private function renderCharts($records)
    {
        ...
        $this->js(
            ...
            (function() {
                ...
                if (tempCtx) {
                    window.tempPatternChart = new Chart(tempCtx, " .
                json_encode($tempPatternOptions) .
                ");
                }
                ...
                if (humidityCtx) {
                    window.humidityPatternChart = new Chart(humidityCtx, " .
                json_encode($humidityPatternOptions) .
                ");
                }
                ...
                json_encode($correlationOptions) .
                ");
                }
            })();
        ",
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-white dark:bg-neutral-800 shadow sm:rounded-lg p-6">
            ...
            <div class="text-center">
                <div
                    class="text-3xl font-bold {{ abs($detailedStats["correlation"] ?? 0) > 0.7 ? "text-green-500" : (abs($detailedStats["correlation"] ?? 0) > 0.3 ? "text-yellow-500" : "text-red-500") }}"
                >
