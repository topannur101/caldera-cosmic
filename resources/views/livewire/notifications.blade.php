...
<div id="content" class="py-12 max-w-2xl mx-auto sm:px-3 text-neutral-800 dark:text-neutral-200">
    ...
    <div class="p-6 flex flex-col sm:flex-row gap-y-6 justify-between items-center">
        ...
        <div>
            <x-text-button type="button" class="uppercase tracking-wide font-bold text-xs" wire:click="markAllAsRead"><i class="fa fa-check mr-2"></i>{{ __('Tandai semua sudah dibaca') }}</x-secondary-button>
        </div>
    </div>
